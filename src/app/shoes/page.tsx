              ...
              >
                <div>
                  ...
                  <div className="relative h-36 sm:h-52 w-full overflow-hidden bg-[#020C1B]">
                    ...
                    />
                    <div className="absolute top-2 left-2 sm:top-2.5 sm:left-2.5 bg-[#020C1B]/90 border border-white/20 text-white text-[9px] sm:text-[10px] font-bold px-1.5 sm:px-2 py-0.5 uppercase tracking-wider">
                  ...
                  <div className="p-2.5 sm:p-4 space-y-1.5 sm:space-y-2">
                    ...
                    <h3 className="font-serif text-xs sm:text-sm font-semibold text-white group-hover:text-slate-200 line-clamp-1">
                      {prod.name}
                    </h3>
                    <p className="text-xs text-slate-400 line-clamp-2 leading-relaxed hidden sm:block">{prod.description}</p>

                    {sizes.length > 0 && (
                      <div className="flex items-center gap-1 pt-0.5">
                        <span className="text-[9px] sm:text-[10px] text-slate-400 uppercase tracking-wider">Sizes:</span>
                        <div className="flex flex-wrap gap-1">
                          {sizes.slice(0, 3).map((s) => (
                            <span key={s} className="text-[9px] sm:text-[10px] bg-[#112240] px-1 py-0.5 border border-white/10 text-slate-200">
                              {s}
                            </span>
                          ))}
                          {sizes.length > 3 && (
                ...
                <div className="p-2.5 sm:p-4 pt-0 sm:pt-0">
                  <Link
                    ...
                    className="w-full flex items-center justify-center gap-1 py-1.5 sm:py-2 bg-white/10 border border-white/20 text-white font-semibold text-[10px] sm:text-xs uppercase tracking-wider sm:tracking-widest hover:bg-white hover:text-[#0A192F] transition-all text-center"
                  >
                    View Details
                  </Link>
                </div>
